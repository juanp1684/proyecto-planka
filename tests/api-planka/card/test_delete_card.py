...
def test_delete_card_with_token(get_token,post_card,use_fixture,token_value,expected_status):
...
def test_delete_card_with_id_card(get_token,id_card,expected_status):
